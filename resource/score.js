	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      votes.map(function (v) {
	        return React.createElement(
	          "td",
	          { className: cx({ empty: v.data[item.track_id] == null }) },
	          v.data[item.track_id]
	        );
	      })
	    );
	  }
	    ...
	    var res = React.createElement(
	      ...
	      React.createElement(
	        ...
	        max_20.map(function (s, ind) {
	          return React.createElement(ScoreRow, { index: ind + 1, votes: votes, item: s, key: s.id });
	        })
	      )
	    );
	    return res;
...
/***/ function(module, exports) {
	...
	datas.sort(function(d1,d2){
	    return d2.vote_count - d1.vote_count;
	});

	var selected = {"211101479":1,"211101504":1,"211594045":1,"211898635":1,"212447780":1,"212447800":1,"212447821":1,"212447875":1,"212448218":1,"212469593":1,"212582616":1,"212582630":1,"212634437":1,"212634950":1,"212748302":1,"212748333":1,"212748589":1,"212748606":1,"212748686":1,"212796206":1};

	var newdata = [];
	for(var i = 0 ; i < datas.length ;++i){
	    if(selected[datas[i].track_id]){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreTable = __webpack_require__(14);
	...
	$.ajax({
	  ...
	  if (data.result.votes != null) {
	    React.render(React.createElement(
	      "div",
	      { className: "" },
	      React.createElement(ScoreTable, { votes: data.result.votes, songs: materialDatas })
